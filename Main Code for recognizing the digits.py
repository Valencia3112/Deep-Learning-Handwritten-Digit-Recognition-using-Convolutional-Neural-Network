...
def plot_confusion_matrix(cls_pred):
    ...
    # Now Working out with precision and Recall
    ...
    print("Printing False Positive values")
...
print("Adding 1st Image now");    
image1 = data.test.images[2];
plot_image(image1);    

print("Adding 13th Image now");
image2 = data.test.images[15];
plot_image(image2);

# Convolution Layer 1
print("Printing output of 1st convolution layer");
plot_conv_weights(weights=weights_conv1);


print("printing all conversion of input image which is input to second convolution layer");
...
print("Output of 2nd Convolution layer for Image 1");
plot_conv_layer(layer=layer_conv2, image=image1);

print("Output of 2nd Convolution layer for Image 2");
